...
public class DxDESCipher {
	...
	private static void printUseage() {
		...
		System.out.println("java -cp DX.jar com.tencent.isd.lhotse.util.DxDESCipher -encrypt plaintext");
		System.out.println("To decrypt a string:");
		System.out.println("java -cp DX.jar com.tencent.isd.lhotse.util.DxDESCipher -decrypt ciphertext");
	}
